                        ...
                        <form action="{{ route('customers.update', $customer->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="name" class="form-control" id="name"
                                    value="{{ old('name', $customer->user->name) }}" placeholder="Enter customer name">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="email" name="email" class="form-control" id="email"
                                    value="{{ old('email', $customer->user->email) }}" placeholder="Enter email">
                            ...
                            <div class="mb-4">
                                ...
                                @if ($customer->image)
                                    <img src="{{ asset('storage/' . $customer->image) }}" alt="Current Image" width="100" class="mt-2">
                                @endif
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="postal_code" class="form-control" id="postal_code"
                                    value="{{ old('postal_code', $customer->postal_code) }}" placeholder="Enter postal code">
                            </div>
