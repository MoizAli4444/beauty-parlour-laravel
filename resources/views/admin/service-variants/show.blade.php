            ...
            <div class="row mb-4">
                <div class="col-12 d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        {!! render_edit_button(route('service-variants.edit', $variant->slug),false) !!}
                ...
                <div class="col-md-8">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <strong>Price:</strong>
                                <div>Rs {{ number_format($variant->price, 2) }}</div>
                            </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body text-center">
                            @if (!empty($variant->image) && file_exists(public_path('storage/' . $variant->image)))
                                <img src="{{ asset('storage/' . $variant->image) }}" class="img-fluid rounded shadow-sm"
                                    alt="Variant Image">
                            @else
